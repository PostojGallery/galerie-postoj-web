(function(){
  ...
  function openSettings(){
    ...
    ov.innerHTML=
      '<div id="cmodal">'+
      '<button id="cmodal-close" aria-label="Close">&#215;</button>'+
      '<h2>Cookie settings</h2>'+
      '<p id="cmodal-desc">Manage your preferences. Essential cookies are required for the website to function and cannot be disabled. Other cookies are activated voluntarily.</p>'+
      '<div class="crow">'+
        '<div class="crow-info"><strong>Essential cookies</strong>'+
        '<span>Core functionality and website security. Cannot be disabled.</span></div>'+
        '<span class="crow-always">Always active</span>'+
      '</div>'+
      '<div class="crow">'+
